   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="col">
            ...
            <p>Ваш адрес электронной почты<span>*</span></p>
      ...
      <p>Выберите аватарку <span>*</span></p>
      <input type="file" name="image" required class="box">
      <p class="link">У вас уже есть учетная запись?<a href="login.php">Войти</a></p>
