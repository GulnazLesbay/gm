...
<section class="playlist">
   ...
   <h1 class="heading">Детали поста</h1>
   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
            <button type="submit" name="save_list"><i class="fas fa-bookmark"></i><span>Сохранить</span></button>
            <?php
               }else{
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>Сохранить пост</span></button>
            <?php
               }
            ?>
         </form>
      ...
      <?php
            ...
            echo '<p class="empty">Этот пост не был найден!</p>';
         }  
      ?>
...
<section class="videos-container">
   ...
   <h1 class="heading">Видео пост</h1>
