...
<section class="liked-videos">
   ...
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="watch_video.php?get_id=<?= $fetch_contents['id']; ?>" class="inline-btn">Посмотреть видео</a>
   ...
   <?php
            ...
            echo '<p class="emtpy">Контента не найдено!</p>';         
         }
      }
   }else{
      echo '<p class="empty">К лайкам пока ничего не добавлено!</p>';
   }
   ?>
