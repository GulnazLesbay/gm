...
<section class="video-form">
   ...
   <h1 class="heading">Обновлять контент</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Статус обновления <span>*</span></p>
      ...
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" selected>-- Выберите пост</option>
         <?php
         ...
         <?php
            ...
            echo '<option value="" disabled>Плейлист еще не создан!</option>';
         }
         ?>
      </select>
      ...
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">Посмотреть</a>
