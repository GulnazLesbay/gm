...
<section class="video-form">
   ...
   <h1 class="heading">Загружать контент</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Пост урока/видеоурока<span>*</span></p>
      <select name="playlist" class="box" required>
         ...
         <?php
            ...
            echo '<option value="" disabled>Пост еще не создан!</option>';
         }
         ?>
      </select>
