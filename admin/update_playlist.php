...
<section class="playlist-form">
   ...
   <h1 class="heading">Изменить пост</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex-btn">
         <input type="submit" value="delete" class="delete-btn" onclick="return confirm('Удалить этот пост?');" name="delete">
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Посмотреть</a>
      </div>
   </form>
   <?php
      } 
   }else{
      echo '<p class="empty">Пост еще не добавлен!</p>';
   }
   ?>
