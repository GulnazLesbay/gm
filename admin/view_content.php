...
<section class="view-content">
   ...
   <?php
      ...
      echo '<p class="empty">Контента еще не добавлено! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
   }
   ...
   <div class="show-comments">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('delete this comment?');">Удалить комментарий</button>
         </form>
      </div>
      <?php
       }
