...
if(isset($_POST['delete_playlist'])){
   ...
   $message[] = 'Пост удалено!';
   }else{
      $message[] = 'Пост уже удалено!';
   }
}
...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">Посмотреть контент</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">Контента не найдено!</p>';
      }
   }else{
      echo '<p class="empty">Пожалуйста, поищите что-нибудь!</p>';
   }
   ?>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="delete_playlist" class="delete-btn" onclick="return confirm('Удалить этот пост?');" name="delete">
         </form>
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">Посмотреть пост</a>
      </div>
      <?php
         } 
      }else{
         echo '<p class="empty">Пост не найден!</p>';
      }}else{
         echo '<p class="empty">Пожалуйста, поищите что-нибудь!</p>';
      }
      ?>
