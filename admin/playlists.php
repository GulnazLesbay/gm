...
<section class="playlists">
   <h1 class="heading">Добавить пост</h1>
   <div class="box-container">
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">Создать новую пост</h3>
         <a href="add_playlist.php" class="btn">Добавить пост</a>
      </div>
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Добавить</a>
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('Удалить эту пост?');" name="delete">
         </form>
      ...
      <?php
         ...
         echo '<p class="empty">Пост еще не добавлена!</p>';
      }
      ?>
