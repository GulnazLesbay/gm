...
<section class="playlist-details">
   ...
   <h1 class="heading">Подробности</h1>
   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Изменить пост</a>
...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn"></a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">Видео еще не добавлено! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Добавлять видео</a></p>';
      }
   ?>
