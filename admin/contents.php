...
<section class="contents">
   <h1 class="heading">Ваш контент</h1>
   <div class="box-container">

   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">Создать новый контент</h3>
      <a href="add_content.php" class="btn">Добавить контент</a>
   </div>
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">Посмотреть содержимое</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">Контент еще не добавлено!</p>';
      }
   ?>
