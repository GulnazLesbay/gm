...
if(isset($_POST['like_content'])){
   ...
   if($user_id != ''){
      ...
      if($select_likes->rowCount() > 0){
         ...
         $message[] = 'Удалено из списка лайков!';
      }else{
         ...
         $message[] = 'Добавлено к лайкам!';
      }

   }else{
      $message[] = 'Пожалуйста, сначала войдите в систему!';
   }
...
<section class="edit-comment">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         <a href="watch_video.php?get_id=<?= $get_id; ?>" class="inline-option-btn">Отменить</a>
...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <form action="" method="post" class="flex">
         ...
         <a href="playlist.php?get_id=<?= $fetch_content['playlist_id']; ?>" class="inline-btn">просмотреть пост</a>
         <?php
            if($verify_likes->rowCount() > 0){
         ?>
         <button type="submit" name="like_content"><i class="fas fa-heart"></i><span>Понравилось</span></button>
         <?php
         }else{
         ?>
         <button type="submit" name="like_content"><i class="far fa-heart"></i><span>Нравиться</span></button>
         <?php
            }
         ?>
      </form>
   ...
   <?php
         ...
         echo '<p class="empty">Видео еще не добавлено!</p>';
      }
   ?>
</section>
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="edit_comment" class="inline-option-btn">Изменить комментарий</button>
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('Удалить этот комментарий?');">Удалить</button>
         </form>
         <?php
         }
         ?>
      ...
      <?php
         ...
         echo '<p class="empty">Комментариев пока не добавлено!</p>';
      }
      ?>
      </div>
</section>
